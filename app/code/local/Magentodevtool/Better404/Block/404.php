<?php
class Magentodevtool_Better404_Block_404 extends Mage_Core_Block_Template
{
    protected $_lint;
    public function _construct()
    {
        $this->_initLint();
        $this->setTemplate('magentodevtool_better404/404.phtml');
    }
    ...
    */
    ...
    {
        $this->_lint = Mage::getModel('magentodevtool_better404/lint');
        return $this->_lint;
    }
